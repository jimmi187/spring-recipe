package com.jimi.recipe.bootstrap;

import com.jimi.recipe.domain.*;
...
@Component
public class RecepyBootstrap implements ApplicationListener<ContextRefreshedEvent> {

    private final CategoryRepository categoryRepository;
    private final RecipeRepository recipeRepository;
    private final UnitOfMeasureRepository unitOfMeasureRepository;

    public RecepyBootstrap(CategoryRepository categoryRepository, RecipeRepository recipeRepository, UnitOfMeasureRepository unitOfMeasureRepository) {
    ...
    private List<Recipe> getRecipes(){
        ...
        guacNotes.setRecipe(guacRecipe);       // bidirectrional
